...
<form action="<?php echo e(route('tenant.requestProcess')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="d-inline-block">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="selected_unit_number" name="unit_number" placeholder="Unit Number" value="<?php echo e($firstUnit->unit_number); ?>" readonly>
            <input type="text" class="form-control" id="selected_unit_name" name="unit_name" placeholder="Unit Name" value="<?php echo e($firstUnit->unit_name); ?>" readonly>
        </div>
    </div>
...
<?php echo $__env->make('layouts.appTenant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\gamev\OneDrive\Desktop\PrimeHub\PrimeHub\resources\views/tenant/request-maintenance.blade.php ENDPATH**/ ?>