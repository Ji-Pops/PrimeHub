...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <form action="{{ route('admin.search-tenants') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
    @csrf
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item" href="{{ route('admin.maintenance-task', ['maintenance_id' => $notification->maintenance_id]) }}" data-id="{{ $notification->maintenance_id }}">
                        <i class="fas fa-exclamation-circle fa-sm fa-fw mr-2 text-gray-400"></i>
                        {{ $notification->message }}
                    </a>
                    @endforeach
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-center small text-gray-500" href="{{ route('admin.maintenance-task') }}">View all notifications</a>
                </div>
            </li>
