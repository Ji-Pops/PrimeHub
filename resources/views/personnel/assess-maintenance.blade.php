...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="card shadow mb-4 h-100">
            ...
            <!-- Card Body -->
            <div class="card-body">
            <form method="POST" action="{{ route('personnel.acceptTask', ['id' => $maintenance->id]) }}" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="card shadow mb-4 h-100">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea name="assessment" class="form-control" required>{{ old('assessment') }}</textarea>
                </div>
                <div class="form-group">
